...
include("auth.php");
require('db.php');
$query = "SELECT * FROM customer_info where queue=0 ORDER BY id ASC";  
...
if (isset($_GET['id'])) {
  ...
  $sql = "UPDATE customer_info SET queue=1 WHERE id=$update";
   ...
   <div id="employee_table">  
        <table class="table table-bordered">  
           ...
           <tr>  
                ...
                <td><a href="order.php?id=<?php echo $row["id"]; ?>" ><button type="button" class="btn btn-warning"  data-toggle="tooltip" data-placement="top" title="Click TO Update">Pending</button></a></td>  
           </tr>  
           <?php  
           }  
           ?>  
